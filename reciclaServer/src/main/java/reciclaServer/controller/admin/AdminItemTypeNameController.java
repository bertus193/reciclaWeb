...
public class AdminItemTypeNameController {
    ...
    public ResponseEntity<?> createPosition(@RequestBody ItemTypeName itemTypeName) throws NoSuchAlgorithmException {
    ...
    public ResponseEntity<?> updatePosition(@RequestBody Position position, @PathVariable("id") String id) throws NoSuchAlgorithmException {
        ...
        if(itemTypeNameFound != null){
            itemTypeNameService.saveItemTypeName(itemTypeNameFound);
        }
